{
 "cells": [
   ...
   "outputs": [
    {
     ...
     "text": [
      ...
      "   window.NREUM||(NREUM={});NREUM.info={\"beacon\":\"bam.nr-data.net\",\"errorBeacon\":\"bam.nr-data.net\",\"licenseKey\":\"5e33925808\",\"applicationID\":\"59562082\",\"transactionName\":\"JVcPR0MLWApSRU1eAQVVEhxSC1oSUlkWbBMHXwRAHhdcCUA=\",\"queueTime\":0,\"applicationTime\":232,\"agent\":\"\"}\n",
      "  </script>\n",
      "  <script type=\"text/javascript\">\n",
      ...
      "   <meta content=\"mgH1eXguPZzn2QV3zmbJJtf5C0RXOH34Bv8FAXMs3R4=\" name=\"csrf-token\">\n",
      "    <title>\n",
      ...
      "       <script src=\"/assets/public_manifest-d392ffac9783d962b13f67dbae0fdc87395cc47f09fd3a47598399cc50ca7653.js\">\n",
      "       </script>\n",
      "       <!--[if gt IE 8]><!-->\n",
  ...
  },
  {
   ...
   "source": [
    "# Looking for title and text for the first news story in the web scrapped results\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "\n",
    "#Use splinter to get to the image\n",
  ...
  },
  {
   ...
   "source": [
    "# Retrive full image\n",
    "find_button = browser.find_by_id('full_image')\n",
    "find_button.first.click()\n",
    "\n",
    "browser.is_text_present('more info', wait_time=2)\n",
    "second_button = browser.click_link_by_partial_text('more info')"
   ]
  },
  {
   "cell_type": "code",
   ...
   "source": [
    ...
    "full_image_soup = soup1.find('figure', class_='lede')\n",
    "\n",
    "h1 = full_image_soup.find('a')\n",
    "href = h1['href']\n",
    "\n",
    "print (href)\n",
    "print('-----------')\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "mars_weather = soup2.find('p', class_ ='tweet-text', text = True).text\n",
    "print(mars_weather)"
   ]
  },
  {
  ...
  },
  {
   ...
   "source": [
    "#Use splinter to get to the image URL\n",
    "url = 'https://astrogeology.usgs.gov/search/results?q=hemisphere+enhanced&k1=target&v1=Mars'\n",
    "browser.visit(url)\n",
    "\n",
    "soup1 = bs(browser.html, 'html.parser')\n",
    "image_detail_box = soup1.find('div', class_='collapsible results')\n",
    "image_details = image_detail_box.find_all('div', class_='item')\n",
    "#title = image_detail_box.find('h3').text\n",
    "print (title)\n",
    "\n",
    "h2 = image_detail_box.find('a')\n",
    "href = h2['href']\n",
    "\n",
    "print (href)\n",
    "print('-----------')\n",
    "featured_image_url1 = 'https://astrogeology.usgs.gov/' + href\n",
  ...
  },
  {
   ...
   "source": [
    "# Retrive full image titles and URLs\n",
    "\n",
    "#Start an empty list to hold all the dictionaries\n",
    "hemisphere_image_urls = []\n",
    "\n",
    "for image_detail_individual in image_details:\n",
    "        image_dict = {}\n",
    "        \n",
    "        #title\n",
    "        title = image_detail_individual.find('h3').text\n",
    "        \n",
    "        #full image\n",
    "        img_href = image_detail_individual.find('a')['href']\n",
    "        img_href_url = 'https://astrogeology.usgs.gov/' + img_href\n",
    "        browser.visit(img_href_url)\n",
    "        full_img_soup = bs(browser.html, 'html.parser')\n",
    "        full_img_detail = full_img_soup.find('img', class_='wide-image')['src']\n",
    "        \n",
    "        full_img_url = 'https://astrogeology.usgs.gov/' + full_img_detail\n",
    "       \n",
